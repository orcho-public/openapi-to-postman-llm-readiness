...
const { formatDataPath, checkIsCorrectType, isKnownType } = require('./common/schemaUtilsCommon.js'),
  ...
  ajvValidationError = require('./ajValidation/ajvValidationError.js'),
  utils = require('./utils.js'),
  { Node, Trie } = require('./trie.js'),
  { validateSchema } = require('./ajValidation/ajvValidation.js'),
  inputValidation = require('./30XUtils/inputValidation.js'),
  ...
  DEFAULT_SCHEMA_UTILS = require('./30XUtils/schemaUtils30X.js'),
  { getRelatedFiles } = require('./relatedFiles.js'),
